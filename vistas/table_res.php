      ...
      <?php 
        ...
        if($laboratorio=="Jenny" and $tipo_lente=="Progresive"){?>
          ...
          <div style="display: flex;justify-content: space-between;">  
            <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px;border-radius: 4px;margin: 2px;padding: 5px">PROGRESSIVE RIGTH <?php echo strtoupper($laboratorio)." DESDE:".date("d-m-Y",strtotime($inicio))." HASTA:".date("d-m-Y",strtotime($fin));?></h5><button type="button" class="btn btn-outline-primary btn-xs"><i class="fas fa-sync-alt"></i> REINICIAR REPORTE</button>
            <?php $pruebas->progresive($inicio,$fin,$laboratorio,$tipo_lente);?>
          </table>
        </div>
          <br><br>
          <table width="100%" class="table-hover table-bordered table-striped" id="datable_aros_inv"  data-order='[[ 0, "desc" ]]'>
          <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px">PROGRESSIVE LEFT <?php echo strtoupper($laboratorio)." DESDE:".date("d-m-Y",strtotime($inicio))." HASTA:".date("d-m-Y",strtotime($fin));?></h5>
            <?php $pruebas->progresiveOI($inicio,$fin,$laboratorio,$tipo_lente);?>
          </table>
        ...
        <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px;">FLAPTOP RIGTH <?php echo strtoupper($laboratorio)." DESDE:".date("d-m-Y",strtotime($inicio))." HASTA:".date("d-m-Y",strtotime($fin));?></h5>
            <?php $pruebas->flaptopOd($inicio,$fin,$laboratorio,$tipo_lente);?>
          </table>
          <br><br>
          <table width="100%" class="table-hover table-bordered table-striped" id="datable_aros_inv"  data-order='[[ 0, "desc" ]]'>
          <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px">FLAPTOP LEFT <?php echo strtoupper($laboratorio)." DESDE:".$inicio." HASTA:".date("d-m-Y",strtotime($fin));?></h5>
            <?php $pruebas->flaptopOi($inicio,$fin,$laboratorio,$tipo_lente);?>
          </table>
         <?php } elseif ($laboratorio=="Lenti" and $tipo_lente=="Visión Sencilla"){?> 
          <table width="100%" class="table-hover table-bordered table-striped" id="datable_aros_inv"  data-order='[[ 0, "desc" ]]'>
          <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px">VISIÓN SENCILLA <?php echo strtoupper($laboratorio)." DESDE:".$inicio." HASTA:".date("d-m-Y",strtotime($fin));?></h5>
            <?php $pruebas->getVisionSencilla();?>
          </table>
        <?php }?>
      </div>
