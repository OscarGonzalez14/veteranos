...
<!-- top-bar -->
  ...
  <div class="content-wrapper">
    ...
    <div style="border-top: 0px">
      ...
      <div class="card card-dark card-outline" style="margin: 2px;">
       <table width="100%" class="table-hover table-bordered table-striped" id="datable_aros_inv"  data-order='[[ 0, "desc" ]]'>     
       <h5 style="text-align: center;background:#034f84;color:white;font-family: Helvetica, Arial, sans-serif;font-size: 16px;">PROGRESSIVE LEFT</h5><i class="fas fa-file-excel"></i>
